...
<a href="../AccountDetails?action=change_info">アカウント情報変更</a><br>
<a href="../AccountDetails?action=change_mail">メールアドレス変更</a><br>
<a href="../AccountDetails?action=change_pass">パスワード変更</a><br>
<a href="../AccountDetails?action=mypage">マイページ</a>
<%} %>
</body>
</html>