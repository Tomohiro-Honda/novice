...
<html>
  ...
  <body >
	...
	<%} %>
      ...
      <form action="../Cart?action=add_cart" method="post">
       <div class="selectbox_color">
		...
		<%if(scStock!=0){ %><option value="1" selected>1</option>
		<%}else{%><option value="" selected disabled>sold out</option><%} %>
			<%for (int i =2; i <= scStock ; i++ ){ %>
		...
		<input type="hidden" name="scStock" value="<%=scStock %>" />
      	<div class="title_buy">
